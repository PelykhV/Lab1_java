...
public class MotelTest {
    ...
    public void testToString() {
        String expected = "Motel(super=Hotel(name=Motel One, totalRooms=50, availableRooms=30, rating=4.0), trackNumber=5, trackKilometer=100, cityFrom=Lviv, cityTo=Kyiv)";
