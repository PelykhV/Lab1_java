...
public class BusinessHotelTest {
    ...
    public void testToString() {
        String expected = "BusinessHotel(super=Hotel(name=Hilton, type=BusinessHotel, totalRooms=200, availableRooms=100, rating=4.5), offices=10, companyOwner=Microsoft)";
