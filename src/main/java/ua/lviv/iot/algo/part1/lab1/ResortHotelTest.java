...
public class ResortHotelTest {
    ...
    public void testToString() {
        String expected = "ResortHotel(super=Hotel(name=Atlantis, type=ResortHotel, totalRooms=500, availableRooms=300, rating=4.8), complexName=Paradise Island, restaurantQuantity=10, childrenPools=2, adultPools=3)";
